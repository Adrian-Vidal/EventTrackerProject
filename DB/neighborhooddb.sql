...
START TRANSACTION;
USE `neighborhooddb`;
INSERT INTO `event` (`id`, `name`, `description`, `create_date`, `last_update`, `image_url`, `enabled`, `neighborhood_id`) VALUES (1, 'Block Party', 'Get ready for an unforgettable day of fun and excitement as we transform Virginia Avenue into a vibrant celebration zone! Community leaders are coming together to shut down the block for an epic party, and you\'re invited!', '2024-09-06', '2024-09-06', 'https://images.nymag.com/guides/everything/blockparties130715_1_560.jpg', 1, 1);
INSERT INTO `event` (`id`, `name`, `description`, `create_date`, `last_update`, `image_url`, `enabled`, `neighborhood_id`) VALUES (2, 'Pool Party', 'Dive into an amazing day of sun, fun, and relaxation at our ultimate pool party! Whether you’re a water lover or just looking to chill, this is the perfect way to spend your day.', '2024-09-06', '2024-09-06', 'https://media-api.xogrp.com/images/6259875e-0312-43bc-8a48-96215e0c4ccc~cr_22.0.2187.1450?quality=50', 1, 1);
...
INSERT INTO `event` (`id`, `name`, `description`, `create_date`, `last_update`, `image_url`, `enabled`, `neighborhood_id`) VALUES (4, 'Sports Day', 'Lace up your sneakers and join us for an action-packed Sports Day on the field! Whether you’re a seasoned athlete or just looking to have some fun, this is the perfect day to get active and enjoy the great outdoors.', '2024-09-06', '2024-09-06', 'https://wearecardinals.com/wp-content/uploads/2020/04/u1Re9qgMfM8d6kumlW85PS6s55jQh5fbdmppgQsP.jpeg', 1, 1);
INSERT INTO `event` (`id`, `name`, `description`, `create_date`, `last_update`, `image_url`, `enabled`, `neighborhood_id`) VALUES (5, 'BBQ', 'Get ready to indulge in a mouthwatering BBQ experience like no other! Our community leaders are firing up the grill and bringing their favorite BBQ dishes and sides for a delicious, fun-filled gathering.', '2024-09-06', '2024-09-06', 'https://www.adamsgrilleprincefrederick.com/wp-content/uploads/2018/06/backyard-bbq.gif', 1, 1);
INSERT INTO `event` (`id`, `name`, `description`, `create_date`, `last_update`, `image_url`, `enabled`, `neighborhood_id`) VALUES (6, 'Garage Sale', 'Got items you no longer need? Don’t let them clutter your home—bring them to our Community Sale Event at the event center!', '2024-09-06', '2024-09-06', 'https://prod-cdn.storespace.com/images/default-source/blogpostsimages/garage-sale-with-various-items.jpg?sfvrsn=9d63cc20_0', 1, 1);
INSERT INTO `event` (`id`, `name`, `description`, `create_date`, `last_update`, `image_url`, `enabled`, `neighborhood_id`) VALUES (7, 'Cultural Food Festival', 'Embark on a culinary adventure and savor a diverse array of international cuisines at our Global Flavors Feast! This is your chance to explore and enjoy dishes from across the globe without ever leaving your neighborhood.', '2024-09-06', '2024-09-06', 'https://static.euronews.com/articles/stories/07/61/61/58/1920x1080_cmsv2_bc594186-8ff2-5815-b4b4-c9b46d45142b-7616158.jpg', 1, 1);
INSERT INTO `event` (`id`, `name`, `description`, `create_date`, `last_update`, `image_url`, `enabled`, `neighborhood_id`) VALUES (8, 'Game Night', 'Get ready for an evening of fun, friendly competition, and endless entertainment at our Game Night! Whether you\'re a casual player or a seasoned pro, there’s something for everyone to enjoy.', '2024-09-06', '2024-09-06', 'https://images.squarespace-cdn.com/content/v1/5542b308e4b07e74b9ce8154/1584492247563-EWKE5V45VGWLX6MM1OFR/game-night.jpg?format=2500w', 1, 1);
INSERT INTO `event` (`id`, `name`, `description`, `create_date`, `last_update`, `image_url`, `enabled`, `neighborhood_id`) VALUES (9, 'Movie Night', 'Relax and unwind with a perfect evening of cinema at our Movie Night! Enjoy a theater-quality experience right in your community with our big screen projectors and surround sound.', '2024-09-06', '2024-09-06', 'https://www.hebrewnational.com/sites/g/files/qyyrlu276/files/images/articles/62bce0c336f6f0c2e6a42c66cc09fa97-main.jpg', 1, 1);
INSERT INTO `event` (`id`, `name`, `description`, `create_date`, `last_update`, `image_url`, `enabled`, `neighborhood_id`) VALUES (10, 'Salsa Night', 'Get ready to spice up your evening with some sizzling salsa moves! Join us for a night of rhythm, fun, and fantastic dance at our Salsa Dancing event.', '2024-09-06', '2024-09-06', 'https://media.istockphoto.com/id/542111772/vector/salsa-night.jpg?s=612x612&w=0&k=20&c=tKex2GCqt6Lq-6MIxsoFcvNJEtI5f2NT1wnFSurPyt0=', 1, 1);
